// config.js — Konfigurasi Supabase, ACTION_MAP, dan token Bot Telegram
    ...
    // ============================================================
    const SUPABASE_URL = 'https://twzjpkaigqzrdcjvypqm.supabase.co';
    const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR3empwa2FpZ3F6cmRjanZ5cHFtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODgwODYxODYsImV4cCI6MjEwMzY2MjE4Nn0.MrQGX5hZLymYV6Vr4o7yQnEoqyH7FW27ujKO1yiCXbM';
